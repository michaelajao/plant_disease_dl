# -*- coding: utf-8 -*-
#
# Plant Disease DL documentation build configuration file, created by
# sphinx-quickstart.
#
...
htmlhelp_basename = 'plant_disease_dldoc'
...
latex_documents = [
    ('index',
     'plant_disease_dl.tex',
     u'Plant Disease DL Documentation',
     u"michael ajao", 'manual'),
]
...
man_pages = [
    ('index', 'plant_disease_dl', u'Plant Disease DL Documentation',
     [u"michael ajao"], 1)
]
